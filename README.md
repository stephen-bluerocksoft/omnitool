...
| `omni-epic-review` | Review a built epic branch one workplan unit at a time -- a brs-review per unit in its own worktree, findings re-verified against HEAD, plus a cross-cutting pass |
